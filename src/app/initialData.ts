...
export const mockFiles: File[] = [
  { id: "1", name: "Documents", type: "folder", parent: null, url: "#", size: "1" },  
  { id: "2", name: "Images", type: "folder", parent: null, url: "#", size: "1"  },
  { id: "3", name: "Work", type: "folder", parent: null, url: "#", size: "1"  },
  {
    id: "4",
    name: "Resume.pdf",
    type: "file",
  ...
  { id: "8", name: "Presentations", type: "folder", parent: "3" , url: "#", size: "1"  },
  {
    id: "9",
    name: "Q4 Report.pptx",
    type: "file",
